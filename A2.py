...
def main():
    ...
    print("Key from SHA256 encryption: "+ K)
    ...
    print(data_C)
    print("Ciphertext URL:")
    print(dbx.sharing_get_file_metadata('/A2/C').preview_url)
    ...
    #1. Fetch W from URL
    #URL: https://www.dropbox.com/s/ropcnvj1x3o7ux6/W?dl=0
    # url = 'https://www.dropbox.com/s/ropcnvj1x3o7ux6/W?dl=0'
    # d = wget.download(url)
    # print(d)
